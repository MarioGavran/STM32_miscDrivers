/************************************************************************************************************
LIBRARY:	SSD1289_FSMC_STM32.h

			- only for STM32F413ZH devices.
			- declares all of the functions for contained in SSD1289_FSMC_STM32.c
...
extern void ssd1289_FSMC_GPIO_init(void);
extern void ssd1289_FSMC_init(void);
extern void ssd1289_Driver_init(void);

extern void Lcd_Write_Reg(uint16_t reg_index, uint16_t reg_data);
extern void	Lcd_Write_Index(uint16_t index);
extern void Lcd_Write_Data(uint16_t data);
extern uint16_t Lcd_Read_Reg_Val(uint16_t reg_addr);
extern uint16_t Lcd_Read_Data_From_Bus(void);

extern void Lcd_Draw_Line(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color, uint8_t size);
extern void Lcd_Draw_Point(uint16_t x, uint16_t y, uint16_t color, uint8_t size);
extern void Lcd_Draw_Image( const uint16_t *ptr_image);

extern void Lcd_Print_String(uint16_t x, uint16_t y, uint16_t color, uint16_t bcolor,  uint8_t *s, uint8_t size);
extern void Lcd_Print_Char( uint16_t x, uint16_t y, uint16_t color, uint16_t bcolor, uint8_t character, uint8_t size);

extern void Lcd_Set_Work_Area(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t color);
extern void Lcd_Set_Cursor(uint16_t x_kur, uint16_t y_kur);
extern void Lcd_Clear(uint16_t color);


extern void Delay_m(uint32_t ms);

// Defines used for accesing data and register transfers
#define SSD1289_REG      (*((volatile uint16_t *) 0x60000000)) 
#define SSD1289_DAT      (*((volatile uint16_t *) 0x60020000))


// Define for reset pin(is not used explicitly by FSMC interface but is used with SSD1289 controller)
#define lcd_rst	6
...
/*Register addresses*/
//**************************************************************************************************//
#define Oscillation_Start 				(0x0000U)
#define Driver_output_control				(0x0001U)
#define LCD_drive_AC_control				(0x0002U)
#define Power_control_1					(0x0003U)
#define Compare_register_1				(0x0005U)
#define Compare_register_2				(0x0006U)
#define Display_control					(0x0007U)
#define Frame_cycle_control				(0x000BU)
#define Power_control_2					(0x000CU)
#define Power_control_3					(0x000DU)
#define Power_control_4					(0x000EU)
#define Gate_scan_start_position			(0x000FU)
#define Sleep_mode					(0x0010U)
#define Entry_mode					(0x0011U)
#define Optimize_Access_Speed_3				(0x0012U)
#define Generic_Interface_Contrl			(0x0015U)
#define Horizontal_Porch				(0x0016U)
#define Vertical_Porch					(0x0017U)
#define Power_control_5					(0x001EU)
#define RAM_data_write_read				(0x0022U)
#define RAM_write_data_mask_1				(0x0023U)
#define RAM_write_data_mask_2				(0x0024U)
#define Frame_Frequency					(0x0025U)
#define VCOM_OTP_1					(0x0028U)
#define Optimize_Access_Speed_1				(0x0028U)	//ista adresa ?
#define VCOM_OTP_2					(0x0029U)
#define Optimize_Access_Speed_2				(0x002FU)
#define gama_control_1					(0x0030U)
#define gama_control_2					(0x0031U)
#define gama_control_3					(0x0032U)
#define gama_control_4					(0x0033U)
#define gama_control_5					(0x0034U)
#define gama_control_6					(0x0035U)
#define gama_control_7					(0x0036U)
#define gama_control_8					(0x0037U)
#define gama_control_9					(0x003AU)
#define gama_control_10					(0x003BU)
#define Vertical_scroll_control_1			(0x0041U)
#define Vertical_scroll_control_2			(0x0042U)
#define Horizontal_RAM_address_position			(0x0044U)
#define Vertical_RAM_address_start_position		(0x0045U)
#define Vertical_RAM_address_end_position		(0x0046U)
#define First_window_start				(0x0048U)
#define First_window_end				(0x0049U)
#define Second_window_start				(0x004AU)
#define Second_window_end				(0x004BU)
#define Set_GDDRAM_X_address_counter			(0x004EU)
#define Set_GDDRAM_Y_address_counter			(0x004FU)
